# -*- coding: utf-8 -*-
"""
Created on Thu Jun 29 10:21:26 2023
...
stats_DIR = os.path.join(INFO_DIR, 'stats/')
###############################################################################
#STEP 1 HP training
...
#     save=os.path.join(churn_norm_DIR, savename[k])
#     all_stats_df.to_csv(save, sep=' ')
###############################################################################
#STEP 2 check HP does lead to a good model and save this
...
# #check split of 1s and 0s and plot this
# plots.plotpie(y=y_train,outDir=PLOT_DIR,name="training_set_pie.png",theset="training")
# plots.plotpie(y=y_val,outDir=PLOT_DIR,name="validation_set_pie.png",theset="validation")
# plots.plotpie(y=y_test,outDir=PLOT_DIR,name="testing_set_pie.png",theset="test")

# #oversampling
# X_train,y_train = structure.applysmote(X_train,y_train)
# plots.plotpie(y=y_train,outDir=PLOT_DIR,name="oversamples_set_pie.png",theset="oversamples training")
# ###############
...
# #                    outDir=PLOT_DIR, plotname='lossplot_bs15e160lr001_3.png')
...
#create confusion matrix
# plots.CM(y_test=test_y, y_pred=test_pred, outDir=PLOT_DIR, name='CM.png__bs15e160lr001_3.png'
#          ,CMmax=8, CMmin=0)
...
save=os.path.join(stats_DIR, 'predictions.csv')
...
save=os.path.join(stats_DIR, 'test_stats.csv')
all_stats_df.to_csv(save, sep=',')
###############################################################################