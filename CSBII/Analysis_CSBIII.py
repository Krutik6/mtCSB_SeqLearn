...
CHURN_DIR = os.path.join(CSBIII_DIR, 'churn/')

###############################################################################
#STEP 1 HP training
########LOAD DATA FROM EXPLORATION AND INITIAL SANITY CHECKS
# df, names = structure.inData(dat = os.path.join(DATA_DIR,'data_csbiii.csv'),
#                               lim =13)
...
# model = MLP.ChurnModel_CSBIII(n_input_dim=X_train.shape[1])
...
# #                     outDir=CSBIII_DIR, plotname='lossplot_bs15e20lr01_3.png')
...
# # plots.CM(y_test=val_y, y_pred=val_pred, outDir=CSBIII_DIR, name='CM.val.png',
# #             CMmax=8, CMmin=0)
...
# # create confusion matrix
# # plots.CM(y_test=test_y, y_pred=test_pred, outDir=CSBIII_DIR, name='CM.png__bs15e160lr001_3.png'
# #           ,CMmax=8, CMmin=0)
...
save=os.path.join(CSBIII_DIR, 'csbiii_predictions.csv')
...
save=os.path.join(CSBIII_DIR, 'csbiii_test_stats.csv')
all_stats_df.to_csv(save, sep=',')
###############################################################################
